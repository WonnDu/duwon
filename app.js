...
// for master bed room
 else if (received_message.payload === "tosel_hou_tell_mb" || received_message.payload === "tosel_hou_tell_both") {    
    response = {
  ...
  // for bed room
   else if (received_message.payload === "tosel_hou_bedRoom" || received_message.payload === "tosel_hou_tell_both") {    
    response = {
